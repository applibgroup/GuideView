...
public class GuideViewBundle {
    ...
    private com.example.easily_tech_guideview_lib.GuideViewBundle.Builder config;
    private GuideViewBundle(@NotNull com.example.easily_tech_guideview_lib.GuideViewBundle.Builder config) {this.config = config;}
    public Component getTargetView() { return config.targetView; }
    public Component getHintView() { return  config.hintView; }
    public int getTransparentSpaceLeft() {return  config.transparentSpaceLeft; }
    public int getTransparentSpaceRight() {return  config.transparentSpaceRight; }
    public int getTransparentSpaceTop() {return  config.transparentSpaceTop; }
    public int getTransparentSpaceBottom() {return  config.transparentSpaceBottom; }
    ...
    public StackLayout.LayoutConfig getHintViewParams() {return config.hintViewParams; }
    public int getMaskColor() {return config.maskColor; }
    public boolean isHasTransparentLayer() { return config.hasTransparentLayer; }
    public int getHintViewDirection() { return config.hintViewDirection; }
    public int getOutlineType() { return config.outlineType; }
    public boolean isDismissOnClicked() { return config.isDismissOnClicked; }
    public boolean isTargetViewClickAble() { return config.isTargetViewClickable; }
    public boolean isDismissOnTouchInTargetView() { return config.isDismissOnClickTargetView; }
    public boolean condition() { return config.condition; }

    public  GuideViewHideListener getGuideViewHideListener() {return config.guideViewHideListener;}
public static class Builder {
    ...
    public GuideViewBundle build() {return new GuideViewBundle(this);}
}
}
